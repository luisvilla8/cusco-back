...
class UpdateTripRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total' => 'sometimes|nullable|numeric|min:0|max:999999.99',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            //  VALIDACIÓN DE NEGOCIO: ¿Puede editar este trip?
            if (!$trip->canUserEdit($user)) {
                $validator->errors()->add('id', 'No tienes permisos para editar este viaje');
                return;
            }
